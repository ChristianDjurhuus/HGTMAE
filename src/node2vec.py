#Script from https://github.com/dmlc/dgl/blob/master/examples/pytorch/node2vec/model.py
...
class Node2vec(nn.Module):
    ...
    def loss(self, pos_trace, neg_trace):
        ...
        pos_start[pos_start==-1] = self.N #if there is no node we assign it to the last node (otherwise it wont run)
